"""module for euler based integration of equation of motion"""

import numpy as np


def eom_euler(position, velocity, force, mass, timestep):
    ...
    final_velocity = velocity + acceleration * timestep
    final_position = position + velocity * timestep
